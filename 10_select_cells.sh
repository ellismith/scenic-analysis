...
#SBATCH --output=/scratch/easmit31/GRN/scenic/scenic_scripts/logs/10_select_cells_%j.out
#SBATCH --error=/scratch/easmit31/GRN/scenic/scenic_scripts/logs/10_select_cells_%j.err
